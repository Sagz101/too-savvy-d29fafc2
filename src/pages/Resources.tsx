...
const resources = [
  ...
  { name: 'API Docs', desc: 'Developer documentation for building on top of the Diminga platform.', icon: Code, route: '/whitepaper', cta: 'API Reference' },
];
    ...
    <div className="pt-24 pb-16 px-4">
      <div className="container mx-auto max-w-5xl">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">Everything you need to master the Diminga platform.</p>
        </motion.div>
