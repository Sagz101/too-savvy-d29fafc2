    ...
    <section className="py-16 bg-card/10">
      <ModernContainer size="xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {trustSignals.map((signal, index) => (
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 bg-green-500/10 border border-green-500/20 rounded-full px-3 py-1 text-green-400 text-xs">
                <CheckCircle size={12} />
                {signal.badge}
              </div>
            </ModernCard>
        ...
        <div className="text-center">
          <ModernText variant="caption" className="text-muted-foreground flex items-center justify-center gap-2">
