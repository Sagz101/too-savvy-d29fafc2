      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-emerald-500/20 to-green-500/20 border border-emerald-400/30 backdrop-blur-xl mb-8">
            ...
            <span className="text-emerald-400 font-semibold">Enterprise Security</span>
          </div>
              ...
              <CardContent className="p-8">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <ExternalLink size={20} className="text-white/60 cursor-pointer hover:text-white transition-colors" />
                  </div>
                </div>
            ...
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="bg-gradient-to-br from-slate-800/90 to-gray-800/90 border border-white/10 backdrop-blur-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20">
                <CardContent className="p-8">
                  ...
                  <div className={`flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r ${testimonial.gradient} bg-opacity-20 border border-white/10`}>
        ...
        <div className="text-center">
          <div className="inline-flex items-center gap-6 px-8 py-4 rounded-2xl bg-gradient-to-r from-slate-800/80 to-gray-800/80 border border-cyan-400/30 backdrop-blur-xl shadow-2xl">
            <div className="flex items-center gap-3">
