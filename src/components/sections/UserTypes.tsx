  ...
  const userTypes = [
    {
      ...
      icon: Users,
      title: 'For Creators',
      description: 'Explore Renegade if you\'re interested in Web3, NFTs, or decentralized monetization. Start with the traditional login to test features before diving into Web3-native tools.',
      features: [
    ...
    },
    {
      ...
      icon: TrendingUp,
      title: 'For Investors',
      description: 'Monitor Renegade\'s adoption metrics (e.g., creator growth, NFT minting volume) and $Neurax token performance to assess its potential in the Web3 creator space.',
      features: [
    ...
    >
      ...
      <ModernContainer size="xl" className="relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          >
            Whether you're creating, building, or investing, Renegade provides the tools and insights 
