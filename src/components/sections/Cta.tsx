  ...
  return (
    <section className="py-24 relative overflow-hidden">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-gradient-to-br from-solar-corona/30 via-solar-photosphere/20 to-solar-chromosphere/10 animate-solar-pulse" style={{ animationDuration: '15s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-solar-core/20 to-transparent animate-solar-pulse" style={{ animationDuration: '10s', animationDelay: '1s' }}></div>
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-neura-dark/70 to-solar-chromosphere/10 backdrop-blur-xl border border-solar-photosphere/40 rounded-3xl p-8 md:p-12 shadow-2xl shadow-solar-core/10">
          <div className="text-center mb-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <Button 
                variant="outline"
                className="border-solar-corona/50 text-white hover:bg-solar-photosphere/20 hover:border-solar-core/60"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="bg-gradient-to-br from-neura-dark/80 to-solar-chromosphere/20 border border-solar-photosphere/30 p-5 rounded-xl text-center">
