        ...
        <div className="space-y-16">
          ...
          <div>
            ...
            <p className="text-white/70 mb-8 max-w-4xl">
              Unlock specialized tools for every step of your creative journey. From NFT minting and token-gated content to streaming, e-commerce, and community governance, Too Savvy Modules are modular, composable, and fully Web3-native.
            </p>
          ...
          <div>
            ...
            <p className="text-white/70 mb-8 max-w-4xl">
              Too Savvy is a self-sustaining creator economy, decentralized across 3,000+ validator nodes, supporting scalable, eco-efficient participation. Engage in projects, launch storefronts, publish content, or govern DAOs—all on a network built for creators.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card id="whitepaper-section" className="bg-neura-dark/50 border-neura-purple/30 backdrop-blur-md">
              ...
              <CardContent className="space-y-4">
                <p className="text-white/70 text-sm">
                  The Too Savvy Whitepaper outlines our foundational thesis: reclaiming creator autonomy through programmable ownership, decentralized infrastructure, and sustainable monetization. It details system architecture, tokenomics, consensus models, and governance mechanics.
                </p>
                <Button className="w-full bg-gradient-to-r from-neura-purple to-neura-cyan text-white">
